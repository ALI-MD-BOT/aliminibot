...
async function arslanPair(number, res = null) {
    ...
    try {
        ...
        // ========== CONNECTION UPDATE (FIXED WELCOME MESSAGE) ==========
...
*© Powered by ${OWNER_NAME}*`;
                ...
                // 2 سیکنڈ کے چھوٹے ڈیلے کے بعد فوراً ویلکم میسج بھیجے گا
                setTimeout(async () => {
                    try {
                        ...
                        arslanLog(`[Connected] Welcome message sent successfully to ${sanitizedNumber}`, 'success');
                    } catch (e) {
