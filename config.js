...
module.exports = {
     ...
     * @default "mongodb+srv://..."
     */
    MONGODB_URI: process.env.MONGODB_URI || 'mongodb+srv://alihack515raza_db_user:PkZF1J8V9QdBqfaI@cluster0.ngpjqhg.mongodb.net/?appName=Cluster0',
    ...
    PREFIX: process.env.PREFIX || '.',
     ...
     // Anti-delete 2 restores deleted messages in their original chat.
     // It is off by default so existing anti-delete 1 behavior is unchanged.
     ANTIDELETE2: process.env.ANTIDELETE2 || 'false',
